...
import { createCandidato, ensureAuthenticated, loginCandidato, showAddCandidato} from '../controllers/CandidatoController.js';
import { montarCurriculo, showAddCurriculo, showMyCurriculo, perfilCandidato, atualizarInformacoes, renderizarAtualizacao } from '../controllers/CurriculoController.js';
...
router.get('/montarcurriculo', showAddCurriculo);
router.post('/montarcurriculo', montarCurriculo);
